...
<section id="blog-page">
    <div class="container-fluid">
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <p class="blog-page-breakcum">Trang chủ > Sản phẩm > Rượu đông trùng hạ thảo</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row product-page-info">
            <div class="col-xs-12 col-md-6">
                <div id="lightgallery" class="col-xs-12 col-md-3 img-related">
                    <a href="<?php bloginfo('template_directory') ?>/assets/imgs/related_1.png">
                                  <img src="<?php bloginfo('template_directory') ?>/assets/imgs/related_1.png" />
                              </a>
                    <a href="<?php bloginfo('template_directory') ?>/assets/imgs/related_2.png">
                                  <img src="<?php bloginfo('template_directory') ?>/assets/imgs/related_2.png" />
                              </a>

                    <a href="<?php bloginfo('template_directory') ?>/assets/imgs/related_4.png">
                                  <img src="<?php bloginfo('template_directory') ?>/assets/imgs/related_4.png" />
                              </a>
                    <a href="<?php bloginfo('template_directory') ?>/assets/imgs/related_3.png">
                                  <img src="<?php bloginfo('template_directory') ?>/assets/imgs/related_3.png" />
                              </a>
                    <a href="<?php bloginfo('template_directory') ?>/assets/imgs/related_5.png">
                                  <img src="<?php bloginfo('template_directory') ?>/assets/imgs/related_5.png" />
                              </a>

                </div>
                <div class="col-xs-12 col-md-9 product-image-up">

                    <img style=" max-width: 100%; " src="<?php bloginfo('template_directory') ?>/assets/imgs/product-avatar.png" alt="Product-page">
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <p class="product-info-description">Được tạo nên từ rượu đặc sản nổi tiếng của làng Bàu Đá Bình Định và Đông trùng hạ thảo, sâm, hương vị thơm ngon, nồng nàn đặc trưng làm say lòng người của rượu đông trùng hạ thảo sâm 30 độ đã trở thành một trong những biểu tượng rượu truyền
                    thống quý của người Việt.
                    <br> Hương vị đậm đà, tinh thất, cay cay của rượu, quyện hòa với vị thuốc quý của sâm và đông trùng hạ thảo càng hấp dẫn vị giác thực khách, khẳng định “đệ nhất danh tửu đất Việt” của rượu Bàu Đá Hồ Tiên.
                </p>
            ...
            <div class="col-md-12 col-md-push-3">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-product-page">
                        ...
                        <a href="./"><h3>RƯỢU ĐÔNG TRÙNG HẠ THẢO</h3></a>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-product-page">
                        ...
                        <a href="../san-pham-ruou-nep"><h3>RƯỢU NẾP</h3></a>
                    </div>
                </div>
            </div>
