...
<?php get_template_part('menu-page'); ?>
 <section id="blog-page">
        <div class="container-fluid">
            <div class="col-xs-12 col-md-6">
                <div class="section-title" style="padding: 0">
                    <h2 style="    margin-top: 6px;padding: 0;"><?php the_title(); ?></h2>
                </div>
            </div>

            <div class="col-xs-12 col-md-6">
                <!-- <div class="selection__button">XEM THÊM</div> -->
               <p class="blog-page-breakcum">Trang chủ > Tin tức > <?php the_title(); ?></p>
            </div>
        </div>
    </section>
    ...
    <section id="content-blog">
        <div class="container">
            <div class="col-xs-12 col-md-9 content-single">
            <?php if (have_posts()) : ?>
                ...
                <a href="<?php the_permalink(); ?>" class="new-blog">
                        <div class="row">
                            ...
                            <div class="content-blog col-xs-12 col-md-12 p-1">
                                ...
                                <div class="blog__text p-1 "><?php the_content(); ?></div>
                                <div class="blog__date blog__tag"><?php the_tags( 'TAGS: ', ', ', '<br />' ); ?></div>
                            </div>
                        </div>
                    </a>
